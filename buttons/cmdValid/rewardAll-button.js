...
module.exports = {
  ...
  async runInteraction(client, interaction, memberSettings) {
    ...
    const buttons = new MessageActionRow()
      ...
      await interaction.update({ content: 'Statut: *Mission terminée* 300 <:XP:854326960586883072> crédités!', components: [buttons], fetchReply: true, deferred : true });
