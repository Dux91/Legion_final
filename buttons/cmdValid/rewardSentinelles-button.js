...
module.exports = {
  ...
  async runInteraction(client, interaction, memberSettings) {
    ...
    const buttons = new MessageActionRow()
      .addComponents(
        new MessageButton()
        .setCustomId('rewardSentinelles-button')
      ...
      await interaction.update({ content: 'Statut: *Mission terminée* 200 <:XP:854326960586883072> crédités!', components: [buttons], fetchReply: true, deferred : true });
